...
public class Ball : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        else
        {
            ...
            float xMultiplier1 = Random.Range(1f, 1.6f);
            float yMultiplier1= Random.Range(0.4f, 1f);
            ...
            float xMultiplier2 = Random.Range(0.2f, 0.8f);
            float yMultiplier2 = Random.Range(1.2f, 1.8f);
